...
% Copyright 2020 The MathWorks, Inc.
    ...
    methods(Access = public)
        ...
        function rlcPDUSet = sendPDU(obj, bytesGranted, remainingTBS)
            ...
            % grant length when transmission and retransmission buffers are
            % empty along with no grant requirement for status PDU
    ...
    methods(Access = private)
        ...
        function sdu = processDataPDU(obj, dataPDU)
            ...
            if ~obj.isInsideReceivingWindow(dataPDUInfo.SequenceNumber) || ...
                ...
                if dataPDUInfo.SegmentationInfo == 0 % Reception of complete SDU
                    [numBytesDiscarded, isReassembled, sdu] = obj.processCompleteSDU(dataPDUInfo);
                else % On the reception of a segmented SDU
                    [numBytesDiscarded, isReassembled, sdu] = obj.processSegmentedSDU(dataPDUInfo);
                end
            end
        ...
        function [numBytesDiscarded, isReassembled, sdu] = processSegmentedSDU(obj, pduInfo)
            ...
            if isReassembled == 1
                ...
                [receivedSDU, sduLen] = obj.RxBuffer{snBufIdx}.getReassembledSDU();
            ...
            for sduIdx = 1:obj.NumTxBufferSDUs
                ...
                if isSegmented
                    ...
                    newPDULength = numel(obj.TxHeaderBuffer{obj.TxBufferFront + 1}) + ...
                        (numel(obj.TxBuffer{obj.TxBufferFront + 1}) - obj.TxSegmentOffset);
