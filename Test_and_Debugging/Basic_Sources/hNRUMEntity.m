    ...
    methods (Access = public)
        ...
        function sdu = receivePDU(obj, packet)
            ...
            if decodedPDU.SegmentationInfo == 0
                ...
                snModuloValue = obj.getModulusValue(decodedPDU.SequenceNumber);
                ...
                if(obj.getModulusValue(obj.RxNextHighest - obj.UMWindowSize) <= ...
                    ...
                    % buffer
                    snBufIdx = obj.assignReassemblyBufIdx(decodedPDU.SequenceNumber);
                    if snBufIdx < 0
                    ...
                    [numDupBytes, isReassembled] = obj.RxBuffer{snBufIdx}.reassembleSegment(decodedPDU.Data, decodedPDU.PDULength, decodedPDU.SegmentOffset, isLastSegment);
                    if numDupBytes
                    ...
                    obj.updateRxState(decodedPDU.SequenceNumber, isReassembled);
                end
            end
    ...
    methods (Access = private)
        ...
        function updateRxState(obj, currPktSeqNum, isReassembled)
            ...
            if isReassembled
                ...
                obj.updateRxGaps(currPktSeqNum);
        ...
        function reassemblyTimerExpiry(obj)
            ...
            if (rxNextHighest > obj.getModulusValue(rxNextReassembly)) || ...
                    ((rxNextHighest == obj.getModulusValue(rxNextReassembly)) && ...
        ...
        function handleOutOfWindowSN(obj, currPktSeqNum)
            ...
            validIndex = obj.getModulusValue(obj.RcvdSNList(:, 1)) > obj.UMWindowSize;
            if any(validIndex)
