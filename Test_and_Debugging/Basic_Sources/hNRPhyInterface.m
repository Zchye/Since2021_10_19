classdef (Abstract) hNRPhyInterface < handle
    ...
    methods(Abstract)
        ...
        %  from MAC for downlink transmissions/receptions. For gNB, it is
        %  sent by gNB MAC for DL transmissions. For UE, it is sent by UE
        %  MAC for DL receptions. MAC sends it at the start of a DL slot
        %  for all the scheduled DL transmission/receptions in the slot.
        %
