    ...
    case 'UMa'
        switch simParameters.ScenarioConfiguration
            case 'A'
                ...
                simParameters.GNBRxAnts = 128;
                simParameters.GNBAntPanelSize = [8 8 2 1 1]; %[M N P Mg Ng]
                simParameters.GNBAntElementSpacing = [0.5 0.8 1 1]; % [dH dV dgv dgh] vertical and horzontal element spacing and panel spacing
                simParameters.GNBAntPolarizationAngles = [45 -45];
                ...
                simParameters.UETxAnts = 4;
                simParameters.UERxAnts = 4;
                simParameters.UEAntPanelSize = [1 2 2 1 1]; %[M N P Mg Ng]
                simParameters.UEAntElementSpacing = [0.5 0.5 1 1]; % [dH dV dgv dgh] vertical and horzontal element spacing and panel spacing
                simParameters.UEAntPolarizationAngles = [0 90];
    ...
    case 'RMa'
        switch simParameters.ScenarioConfiguration
            case 'A'
                ...
                %YXC begin
                simParameters.GNBRxAnts = 1;%64;
                %YXC end
                simParameters.GNBAntPanelSize = [8 4 2 1 1]; %[M N P Mg Ng]
                simParameters.GNBAntElementSpacing = [0.5 0.8 1 1]; % [dH dV dgv dgh] vertical and horzontal element spacing and panel spacing
                simParameters.GNBAntPolarizationAngles = [45 -45];
                simParameters.GNBAntElement = '38.901';
                simParameters.GNBAntPolarizationModel = 'Model-2';
                ...
                simParameters.UETxPower = 23; % Tx power for all the UEs in dBm
                %YXC begin
                simParameters.UETxAnts = 1;%2;
                %YXC end
                simParameters.UERxAnts = 2;
                simParameters.UEAntPanelSize = [1 1 2 1 1]; %[M N P Mg Ng]
                simParameters.UEAntElementSpacing = [0.5 0.5 1 1]; % [dH dV dgv dgh] vertical and horzontal element spacing and panel spacing
                simParameters.UEAntPolarizationAngles = [0 90];
                simParameters.UEAntElement = 'isotropic';
                simParameters.UEAntPolarizationModel = 'Model-2';
...
simParameters.ParametersLogFile = 'Jeye_simParameters'; % For logging the simulation parameters
simParameters.SimulationLogFile = 'Jeye_simulationLogs'; % For logging the simulation logs
...
simParameters.gNBBearing = 0;
simParameters.GNBPositions = [0,0,simParameters.gNBHeight];
simParameters.UEPositions = {[100,0,simParameters.UEHeight]};
