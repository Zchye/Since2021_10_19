...
%                     obj.ChannelModel.NumStrongestClusters = 0;
                    ...
                    %MXC_2
                    %YXC begin
                    %obj.TxAntPanel = param.UEAntPanelSize;
                    %YXC end
                    obj.RxAntPanel = param.UEAntPanelSize;
                    
                    %gNB Antenna Config
                    obj.ChannelModel.TransmitAntennaArray.Size = param.GNBAntPanelSize;
                    obj.ChannelModel.TransmitAntennaArray.ElementSpacing = param.GNBAntElementSpacing;
                    obj.ChannelModel.TransmitAntennaArray.PolarizationAngles = param.GNBAntPolarizationAngles;
                    ...
                    %UE Antenna Config
                    obj.ChannelModel.ReceiveAntennaArray.Size = obj.RxAntPanel;
                    obj.ChannelModel.ReceiveAntennaArray.ElementSpacing = param.UEAntElementSpacing;
                    obj.ChannelModel.ReceiveAntennaArray.PolarizationAngles = param.UEAntPolarizationAngles;
