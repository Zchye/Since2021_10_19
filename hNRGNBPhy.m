    ...
    methods (Access = private)
        ...
        function updatedSlotGrid = populatePDSCH(obj, pdschPDU, macPDU, txSlotGrid)
            ...
            for i=1:length(pdschPDU) % For each PDSCH scheduled for this slot
                ...
                if ndims(W) < 4 % If the precoder is generated by codebook
                    [pdschAntSymbols, pdschAntIndices] = hPRGPrecode(size(txSlotGrid), carrierConfig.NStartGrid, pdschSymbols, pdschIndices, W);
                else % The precoder is generated by yPrecodedSINR.m
                    [pdschAntSymbols, pdschAntIndices] = yPRGPrecode(size(txSlotGrid), carrierConfig.NStartGrid, pdschSymbols, pdschIndices, W);
                end
                %YXC begin
                % Antenna virtualization
                ...
                if ndims(W) < 4 % If the precoder is generated by codebook
                    ...
                    [dmrsAntSymbols, dmrsAntIndices] = yPRGPrecode(size(txSlotGrid), carrierConfig.NStartGrid, dmrsSymbols, dmrsIndices, W);
                end
                %YXC begin
                % Antenna virtualization
