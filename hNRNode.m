classdef (Abstract) hNRNode < hWirelessNode
    ...
    methods (Access = public)
        function obj = hNRNode()
            ...
            obj.AppLayer = helperApplication('NodeID', obj.NodeID, 'MaxApplications', ...
                obj.MaxApplications);
        end
        ...
        function addApplication(obj, rnti, lcid, app)
            ...
            obj.AppLayer.addApplication(app, metadata);
        end
        ...
        function configureLogicalChannel(obj, rnti, rlcChannelConfig)
            ...
            obj.RLCEntities{logicalChannelSetIndex, lchIdx}.registerAppReceiverFcn(@appLayer.receivePacket);
            % Register MAC interface function with the RLC entity
            obj.RLCEntities{logicalChannelSetIndex, lchIdx}.registerMACInterfaceFcn(@macEntity.updateBufferStatus);
            ...
            macEntity.addLogicalChannelInfo(lcConfig, rnti);
        end
