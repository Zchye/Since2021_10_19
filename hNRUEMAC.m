...
%#codegen
    ...
    methods
        ...
        function dlControlRequest(obj)
            ...
            if(obj.DuplexMode == 0 || ~isempty(find(obj.DLULSlotFormat(obj.CurrDLULSlotIndex + 1, :) == obj.DLType, 1)))
                ...
                if ~(obj.DuplexMode == 1 && all(obj.DLULSlotFormat(obj.CurrDLULSlotIndex + 1, csirsLocations+1) ~= obj.DLType))
                    % Set carrier configuration object
                    carrier = nrCarrierConfig;
                    carrier.SubcarrierSpacing = obj.SCS;
                    carrier.NSizeGrid = obj.NumPDSCHRBs;
    ...
    methods (Access = private)
        function [pduLen, type] = sendMACPDU(obj, uplinkGrant)
            ...
            puschInfo.PUSCHConfig.DMRS = nrPUSCHDMRSConfig('DMRSConfigurationType', obj.PUSCHDMRSConfigurationType, ...
                'DMRSTypeAPosition', obj.DMRSTypeAPosition, 'DMRSLength', uplinkGrant.DMRSLength, ...
        ...
        function rxRequestToPhy(obj, downlinkGrant)
            ...
            pdschInfo.PDSCHConfig.DMRS = nrPDSCHDMRSConfig('DMRSConfigurationType', obj.PDSCHDMRSConfigurationType, ...
                'DMRSTypeAPosition', obj.DMRSTypeAPosition, 'DMRSLength', downlinkGrant.DMRSLength, ...
